                        ...
                        <div className="tp-login-top text-center mb-50">
                           <h3 className="d-flex align-items-center justify-content-center tp-login-title gap-2 py-2">
                                <Link className='d-flex align-items-center gap-2' href="/">
                                    <img src="/assets/img/logo/logo.png" alt="logo" style={{width:'80px'}}/> 
                                    <span>Aljeco </span>
                                </Link>
                            </h3>
                        ...
                        <div className="tp-login-option">
                           ...
                           <div className="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                              ...
                              <div className='d-flex align-items-center gap-1'>
                                 <input type="checkbox" id="rememberMe" className="custom-checkbox1" />
                                 <label className='d-flex align-items-center' htmlFor="rememberMe">Remember me</label>
                              </div>
                           </div>
                           <div className="tp-login-bottom">
                              <a href="#" className="tp-login-btn w-100"><MdLogin style={{ fontSize: "18px" }} /> Signup</a>
                           </div>
                        </div>
                     </div>
                  </div>
